...
export default function VehicleIdentificationSignsPage() {
        ...
        <div>
          ...
          <div className="mb-8">
            <p className="text-[#222] text-lg leading-relaxed max-w-4xl">
              Տրանսպորտային միջոցների վրա անհրաժեշտության դեպքում պետք է
              տեղադրվեն կամ պատկերվեն տրանսպորտային միջոցի ճանաչման նշաններ:
              Բացի «Բժիշկ» և «Հաշմանդամ» ճանաչման նշաններից, որոնք տեղադրվում են
              վարորդի ցանկությամբ, մյուս բոլոր ճանաչման նշանների տեղադրումը
              պարտադիր է, եթե առկա է դրանցով նշվող հանգամանքը:
            </p>
          </div>
